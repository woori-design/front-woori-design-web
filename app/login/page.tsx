      ...
      <main className="flex-1 flex items-center justify-center p-7">
        <div className="w-full max-w-md p-8 rounded-lg border">
          ...
          <div className="space-y-4">
            <button className="w-full flex items-center justify-center gap-2 bg-[#FEE500] text-black py-3 px-4 rounded-md">
            ...
            <button className="w-full flex items-center justify-center gap-2 bg-black text-white py-3 px-4 rounded-md">
